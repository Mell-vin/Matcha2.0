...
ADD IF NOT EXISTS latitude FLOAT DEFAULT '0.00',
ADD IF NOT EXISTS longitude FLOAT DEFAULT '0.00',
ADD IF NOT EXISTS iploc VARCHAR(200) NOT NULL DEFAULT 'HIDDEN'
;